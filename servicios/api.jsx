...
import { db, collection, addDoc, getDocs } from './Credenciales';  // Importa correctamente las funciones
...
const TestFirestore = () => {
  ...
  const [idMaqueta, setMaqueta] = useState('');
    ...
    <div>
      ...
      <div>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <input 
            type="text" 
            placeholder="Propietario del producto" 
            value={propietario}
